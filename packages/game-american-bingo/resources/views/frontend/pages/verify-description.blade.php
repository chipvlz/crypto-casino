<p>
    ...
    {{ __('The server secret represents a list of 35 unique random numbers from 1 to 75.') }}
...
<p>
    ...
    {{ __('The result number will be used to adjust each of the 35 numbers generated before the game.') }}
