	...
	<script>
		window.addEventListener("DOMContentLoaded",function(){
			...
			window.game_slots_proto({
				...
				min_bet					: {{ config('game-multi-slots.min_bet') }},
				max_bet					: {{ config('game-multi-slots.max_bet') }},
				bet_change_amount		: {{ config('game-multi-slots.bet_change_amount') }},
				default_bet				: {{ config('game-multi-slots.default_bet') }},
