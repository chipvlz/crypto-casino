<p>
    ...
    {{ __('The server secret represents random roulette position (from 0 to 36).') }}
    {{ __('The server seed is a cryptographically secure random alpha-numeric string.') }}
    {{ __('The hash of these 2 strings helps to ensure that the initial roulette position is not altered after you make a bet.') }}
...
<p>
    ...
    {{ __('The result number will be used to rotate the roulette wheel N extra times.') }}
    {{ __('Because the client seed can not be predicted by the server the number of extra roulette spins is completely random and hence you can be sure that the game result is fair.') }}
</p>