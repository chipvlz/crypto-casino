...
@section('content')
    ...
    <div class="card border-primary mb-3">
        <div class="card-body">
            ...
            <pre class="alert alert-info">* * * * * php -d register_argc_argv=On {{ base_path() }}/artisan schedule:run >> /dev/null 2>&1</pre>
            <p class="text-muted">
    ...
    <div class="card border-primary mb-3">
        <div class="card-body">
            ...
            @if($log_size)
                <p class="text-muted">{{ __('Application log file size is :n MB.', ['n' => $log_size]) }}</p>
