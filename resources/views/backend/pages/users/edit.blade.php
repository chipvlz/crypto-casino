...
@section('content')
    <form method="POST" action="{{ route('backend.users.update', $user) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group referral-bonus-field {{ old('individual_referral_bonuses', $user->has_individual_referral_bonuses) ? '' : 'hidden' }}">
            ...
            <div class="input-group">
                <input type="text" name="referee_sign_up_credits" class="form-control {{ $errors->has('referee_sign_up_credits') ? 'is-invalid' : '' }}" placeholder="{{ config('settings.referral.referee_sign_up_credits') }}" value="{{ old('referee_sign_up_credits', $user->referee_sign_up_credits) }}">
        ...
        <div class="form-group referral-bonus-field {{ old('individual_referral_bonuses', $user->has_individual_referral_bonuses) ? '' : 'hidden' }}">
            ...
            <div class="input-group">
                <input type="text" name="referrer_sign_up_credits" class="form-control {{ $errors->has('referrer_sign_up_credits') ? 'is-invalid' : '' }}" placeholder="{{ config('settings.referral.referrer_sign_up_credits') }}" value="{{ old('referrer_sign_up_credits', $user->referrer_sign_up_credits) }}">
                <div class="input-group-append">
                    <span class="input-group-text">{{ __('credits') }}</span>
                </div>
            </div>
        ...
        <div class="form-group referral-bonus-field {{ old('individual_referral_bonuses', $user->has_individual_referral_bonuses) ? '' : 'hidden' }}">
            ...
            <div class="input-group">
                <input type="text" name="referrer_game_bet_pct" class="form-control {{ $errors->has('referrer_game_bet_pct') ? 'is-invalid' : '' }}" placeholder="{{ config('settings.referral.referrer_game_bet_pct') }}" value="{{ old('referrer_game_bet_pct', $user->referrer_game_bet_pct) }}">
                <div class="input-group-append">
        ...
        <div class="form-group referral-bonus-field {{ old('individual_referral_bonuses', $user->has_individual_referral_bonuses) ? '' : 'hidden' }}">
            ...
            <div class="input-group">
                <input type="text" name="referrer_deposit_pct" class="form-control {{ $errors->has('referrer_deposit_pct') ? 'is-invalid' : '' }}" placeholder="{{ config('settings.referral.referrer_deposit_pct') }}" value="{{ old('referrer_deposit_pct', $user->referrer_deposit_pct) }}">
                <div class="input-group-append">
                    <span class="input-group-text">%</span>
                </div>
            </div>
