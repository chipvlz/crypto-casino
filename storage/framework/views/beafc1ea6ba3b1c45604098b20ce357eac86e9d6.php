                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <?php if(config('settings.recaptcha.public_key')): ?>
                            <div class="form-group row">
                                <div class="col-md-6 offset-md-4">
                                    <div class="g-recaptcha" data-sitekey="<?php echo e(config('settings.recaptcha.public_key')); ?>" data-theme="<?php echo e(config('settings.theme')=='dark-purple' ? 'dark' : 'light'); ?>"></div>
                                </div>
                            </div>
                        <?php endif; ?>
