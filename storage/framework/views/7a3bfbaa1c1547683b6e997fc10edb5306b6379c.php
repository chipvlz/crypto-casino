...
<?php $__env->startSection('title'); ?>
    <?php echo e(__(config('game-multi-slots.titles')[$index])); ?>
				...
				<div class="section-paytable show" data-section="paytable">
					<?php $__currentLoopData = $symbols; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sym): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					    <div class="paytable-symbol">
							<div class="image"><img src="<?php echo e(asset('storage/games/multi-slots/'.$index.'/'.$sym['filename'])); ?>"></div>
							<div class="lines">
								<?php if($sym["wild"]): ?>
						...
						<?php $__currentLoopData = $reels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="reel">
								<?php $__currentLoopData = $reel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sym_idx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<div class="image"><img src="<?php echo e(asset('storage/games/multi-slots/'.$index.'/'.$symbols[$sym_idx]['filename'])); ?>"></div>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</div>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</div>
	...
	<script>
		window.addEventListener("DOMContentLoaded",function(){
			...
			window.game_slots_proto({
				...
				play					: "<?php echo e(route('games.multi-slots.play', ['index' => $index])); ?>",
				token					: "<?php echo e(csrf_token()); ?>",
				syms					: syms,
				paytable				: <?php echo json_encode($paytable); ?>,
				min_bet					: <?php echo e(config('game-multi-slots.min_bet')[$index]); ?>,
				max_bet					: <?php echo e(config('game-multi-slots.max_bet')[$index]); ?>,
				max_bet					: <?php echo e(config('game-multi-slots.max_bet')[$index]); ?>,
				bet_change_amount		: <?php echo e(config('game-multi-slots.bet_change_amount')[$index]); ?>,
				default_bet				: <?php echo e(config('game-multi-slots.default_bet')[$index]); ?>,
				default_lines			: <?php echo e(config('game-multi-slots.default_lines')[$index]); ?>,
				balance					: <?php echo e(auth()->user()->account->balance); ?>,
				reels					: <?php echo e(json_encode($reels)); ?>,
				lines					: <?php echo e(json_encode(\Packages\GameMultiSlots\Services\GameMultiSlotsService::lines)); ?>,
				animation_frames		: 14,
				animation_time			: 28,
				animation_size			: 200
			});
